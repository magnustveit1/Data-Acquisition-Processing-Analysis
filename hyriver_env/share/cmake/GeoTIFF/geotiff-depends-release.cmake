...
set_target_properties(geotiff_library PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgeotiff.so.5.2.4"
  IMPORTED_SONAME_RELEASE "libgeotiff.so.5"
  )

list(APPEND _cmake_import_check_targets geotiff_library )
list(APPEND _cmake_import_check_files_for_geotiff_library "${_IMPORT_PREFIX}/lib/libgeotiff.so.5.2.4" )
